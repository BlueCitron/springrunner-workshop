...
/**
 * {@link HttpServletRequest}에서 사용자 세션({@link UserSession}을 사용 할 수 있도록 지원하는 필터 구현체
 *
...
public class UserSessionFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        HttpServletRequest userSessionRequest = 
        		new UserSessionRequestWrapper(request, userSessionRepository.get());
        filterChain.doFilter(userSessionRequest, response);
    }


    /**
     * 사용자 세션을 기반으로 인증 개체와 역할 확인 기능을 제공
     *
     * @author springrunner.kr@gmail.com
     */
